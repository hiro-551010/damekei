...
| 項目 | 懸念点 |
|---|---|
| W ダメージ値 | W 自体は移動+トグルスキルであり直接ダメージがない。Meraki が Snack Attack（強化 AA ボーナス）の値を W として返しているか、または空値かを確認すること |
| E ダメージ値 | チャージ時間によってダメージが変化する場合、Meraki が最大チャージ時か最小か不明。確認すること |
